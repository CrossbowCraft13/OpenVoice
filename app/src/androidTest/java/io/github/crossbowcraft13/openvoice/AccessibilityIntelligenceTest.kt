...
import io.github.crossbowcraft13.openvoice.accessibility.engine.*
import io.github.crossbowcraft13.openvoice.task.TaskBlackboard
import io.github.crossbowcraft13.openvoice.task.CompletionStatus
...
class AccessibilityIntelligenceTest {
    ...
    private fun semanticToUiNode(node: SemanticUiNode): io.github.crossbowcraft13.openvoice.accessibility.UiNode =
        io.github.crossbowcraft13.openvoice.accessibility.UiNode(
    ...
    fun semanticUiNode_fromUiNode_mapsCorrectly() {
        val node = io.github.crossbowcraft13.openvoice.accessibility.UiNode(
