package io.github.crossbowcraft13.openvoice.task
...
class TaskBlackboard @Inject constructor() {
    ...
    fun getTimeline(): String = buildString {
        ...
        appendLine("🧠 Route: ${s.resolution?.let {
            when (it) {
                is io.github.crossbowcraft13.openvoice.router.Resolution.Native -> "Native: ${it.operatorId}"
                is io.github.crossbowcraft13.openvoice.router.Resolution.Accessibility -> "Accessibility"
